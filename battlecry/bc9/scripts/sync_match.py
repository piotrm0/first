...
#                                 "WHERE m.EventID = %s AND d.EventID = m.EventID AND m.ScheduleID = d.ScheduleID" % (sync_conf.EVENT_ID))
                                 "WHERE m.EventID = %s AND d.EventID = m.EventID AND m.ScheduleID = d.ScheduleID AND m.TournamentLevel > 1" % (sync_conf.EVENT_ID))
