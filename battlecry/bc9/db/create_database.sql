...
CREATE TABLE game_match (
	...
	winner_color_id INT2 NOT NULL DEFAULT 0 REFERENCES color
);
...
CREATE TABLE alliance_team (
	...
	PRIMARY KEY (match_level, match_number, match_index, alliance_color_id, position),
...
CREATE TABLE team_score (
	...
	match_number INT2,
	match_index INT2,
	alliance_color_id INT2,
	position INT2,
--	FOREIGN KEY (match_level, match_number, match_index, alliance_color_id, position) REFERENCES alliance_team,
	score_attribute_id INT REFERENCES score_attribute,
	PRIMARY KEY (match_level, match_number, match_index, alliance_color_id, position, score_attribute_id),
	value INT DEFAULT 0
);
...
CREATE TABLE finals_alliance_partner (
	...
	team_number INT UNIQUE NOT NULL DEFAULT 0
);
